...
public class DirectAddDelUpdateConsumer {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //监听消息
        channel.basicConsume(MqConst.AddDelUpdateQueue,false,new DefaultConsumer(channel){  //手动动ack
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("我是 DirectAddDelUpdateConsumer 接收到msg: "+msg);
